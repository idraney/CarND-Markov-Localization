                                     ...
                                     float pseudo_position)
{
    ...
    {
        // Append to pseudo_ranges vector if greater than 0
        if (landmark_positions.at(i) - pseudo_position > 0)
        {
            pseudo_ranges.push_back(landmark_positions.at(i) - pseudo_position);
        }
    }
